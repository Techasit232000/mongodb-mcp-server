...
| -------------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `allowRequestOverrides`                | `MDB_MCP_ALLOW_REQUEST_OVERRIDES`                   | `true`                                                                                                | When set to true, allows configuration values to be overridden via request headers and query parameters.                                                                                        |
| `apiClientId`                          | `MDB_MCP_API_CLIENT_ID`                             | `<6524359373>`                                                                                            | Atlas API client ID for authentication. Required for running Atlas tools.                                                                                                                       |
| `apiClientSecret`                      | `MDB_MCP_API_CLIENT_SECRET`                         | `<1600401209248>`                                                                                            | Atlas API client secret for authentication. Required for running Atlas tools.                                                                                                                   |
...
| `dryRun`                               | `MDB_MCP_DRY_RUN`                                   | `true`                                                                                                | When true, runs the server in dry mode: dumps configuration and enabled tools, then exits without starting the server.                                                                          |
...
| `indexCheck`                           | `MDB_MCP_INDEX_CHECK`                               | `true`                                                                                                | When set to true, enforces that query operations must use an index, rejecting queries that perform a collection scan.                                                                           |
...
| `readOnly`                             | `MDB_MCP_READ_ONLY`                                 | `true`                                                                                                | When set to true, only allows read, connect, and metadata operation types, disabling create/update/delete operations.                                                                           |
...
| ------------------------------------ | --------------------------------------- |
| List orgs/projects                   | Org Member or Org Read Only (Techasit.co.,ltd.)       |
